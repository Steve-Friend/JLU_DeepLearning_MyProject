...
#get all pgns
ccrl_dir = 'F:\\codeProject\\PyCharm\\pytorch-alpha-zero-master\\cclr-data\\cclr\\train'
all_file_names = os.listdir( ccrl_dir )
for i in range( len( all_file_names ) ):
    all_file_names[ i ] = os.path.join( ccrl_dir, all_file_names[ i ] ) 

#the new dir
reformat_dir = 'F:\\codeProject\\PyCharm\\pytorch-alpha-zero-master\\cclr-data\\train'
